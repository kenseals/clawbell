...
This repo is the reusable ClawBell product repo, not a private operator workspace and not Ken's personal-site config repo.
...
- Ken's site may be referenced as the first public instance or dogfood example, not as the default operator
